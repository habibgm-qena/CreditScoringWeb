            ...
            <CardContent>
              <div className="grid w-full items-center">
                <div className="flex flex-col ">
                  ...
                  <Input id="totalCredit" type="number" placeholder="1000.0" onChange={(e) => { setTotalCredit(e.target!.value) }} />
                </div>
                <div className="flex flex-col ">
                  ...
                  <Input id="totalDebit" type="number" placeholder="2000.0" onChange={(e) => { setTotalDebit(e.target!.value) }} />
                </div>
                <div className="flex flex-col ">
                  ...
                  <Input id="netAMT" type="number" placeholder="1500.12" onChange={(e) => { setNetAMT(e.target!.value) }} />
                </div>
                <div className="flex flex-col ">
                  ...
                  <Input id="totalRate" type="number" placeholder="0.5" onChange={(e) => { setTotalRate(e.target!.value) }} />
                </div>
              </div>
            </CardContent>
            <CardFooter />
            ...
            <CardContent>
              <div className="grid w-full items-center">
                <div className="flex flex-col">
                  ...
                  <Input id="anualIncome" type="number" placeholder="300000.0" onChange={(e) => { setAnualIncome(e.target!.value) }} />
                </div>
                <div className="flex flex-col">
                  <UILabel htmlFor="currentCapital">Bussiness Current Capital <HoverDescription title={inputDescriptions.currentCapital.title} description={inputDescriptions.currentCapital.description} /> </UILabel>
                ...
                <div className="flex flex-col">
                  ...
                  <Input id="annualProfit" type="number" placeholder="1000000.0" onChange={(e) => { setAnnualProfit(e.target!.value) }} />
                </div>
              </div>
            </CardContent>
          </div>
